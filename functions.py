...
class Download_UI:
    def __init__(self, parent, video_url, pv_frame):
        ...
        self.progressBar = customtkinter.CTkProgressBar(self.download_frame, width=200)
    ...
    def download(self):
        try:
            ...
            with yt_dlp.YoutubeDL(option) as yld:
                ...
                messagebox.showinfo("Download Complete", f'Your video was downloaded successfully at {filename}')
    ...
    def __init__(self, c):
        ...
        if player_url:
            ...
            if c.x.get()=='Light':
                ...
                self.play = customtkinter.CTkImage(PIL.Image.open("Icons/play-button-White.png"), size=(20,20))
                self.pause_icon = customtkinter.CTkImage(
            ...
            download_button = customtkinter.CTkButton(
                self.root,
                text="Download",
                image=(download_icon if c.x.get() == "Light" else download_icon_light),
                compound="left",
                font=("Roboto mono", 15),
            ...
            null = customtkinter.CTkLabel(self.root, text=" ", height=10).pack()
